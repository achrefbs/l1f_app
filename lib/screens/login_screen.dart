...
@override
  ...
  send(AuthHelper auth) {
    ...
    auth
        ...
        .then((value) {
      if (value == Errors.none && value.toString().length > 0) {
      ...
      } else if (value == Errors.wrongError || value.toString().length == 0) {
        ...
        bottomRight: Radius.circular(40),
            ...
            Column(children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: IconButton( color: kPlayerCardColorPrimary,
                    icon:
            ...
            SizedBox(
              ...
              ElevatedButton(
                ...
                child: const Text('Login', style: TextStyle(color: kTransparentBackgroundColor, fontWeight: FontWeight.bold),),
              ),
            ),
            ...
            Row(
              ...
              children: [
                const Text('Don\'t have an account?', style: TextStyle(fontWeight: FontWeight.bold, color: kTransparentBackgroundColor) ,),
                TextButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                      context,
                  ...
                  child: const Text('Sign up', style: TextStyle(color: kPlayerCardColorPrimary)),
                ),
              ],
            ),
