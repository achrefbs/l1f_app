  ...
  Widget build(BuildContext context) {
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          if (snapshot.hasError) {
            return Text(
                'Error in receiving teams photos: ${snapshot.error}');
          }
              if (snapshot.hasData) {
    ...
    border: Border.all(
      width: 1,
                            ...
                            child: InkWell(
                              child: Image.asset(image.toString(), height: 50,
    width: 100,),
                              onTap: () {
                                setState(() {
                                  favteamclick = index;
    ...
    return Scaffold(
      ...
      Container(decoration: const BoxDecoration(
        ...
        Column(
          children: [
            ...
            Text("Sign Up", style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
            SizedBox(
              height: MediaQuery.of(context).size.height * 0.05,
            ),
            Column(children: [
      ...
      Padding(child: Align(alignment: Alignment.centerLeft, child: Text('Select your favorite team', style: TextStyle(color: Colors.grey,),)), 
...
teamPhotos
              ...
              ElevatedButton(
                ...
                child: const Text('Sign Up', style: TextStyle(color: kTransparentBackgroundColor, fontWeight: FontWeight.bold),),
              ), 
            ]),
